...
* @param {number} height
*/
export function caterpilar_game_resize(width: number, height: number): void;
/**
* @param {number} width
* @param {number} height
* @param {number} scale
*/
export function caterpilar_game_resize_with_scale(width: number, height: number, scale: number): void;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly caterpilar_game_resize: (a: number, b: number) => void;
  readonly caterpilar_game_resize_with_scale: (a: number, b: number, c: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h047bf03afd842e9e: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfb384d473af61b72: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc0da8b6db1db3d14: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h747155ffc38a5a82: (a: number, b: number, c: number) => void;
